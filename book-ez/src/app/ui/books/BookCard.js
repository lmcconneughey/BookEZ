...
const BookCard = ({book}) => {
    return (
        <Link href={`/store/${book.id}`} >
            <div className="flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg my-4 w-70">
                ...
                <div>
                    <div className="p-6 text-center">
                        <h1 className="mb-1 text-xl font-semibold text-slate-800">{book.title}</h1>
